...
class Solution(object):
    ...
    def is_overlapped(
        ...
        """Returns whether first_pair/second_pair overlap entirely."""

        first_ints = [int(s) for s in first_pair]
        second_ints = [int(s) for s in second_pair]

        return (
            first_ints[0] <= second_ints[0] and first_ints[1] >= second_ints[1]
        ) or (
            second_ints[0] <= first_ints[0] and second_ints[1] >= first_ints[1]
        )
